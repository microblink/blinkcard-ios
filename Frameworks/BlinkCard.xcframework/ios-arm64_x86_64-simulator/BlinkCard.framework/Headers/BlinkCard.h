...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BlinkCard",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9BlinkCard12CrashMonitor")
...
@interface CrashMonitor (SWIFT_EXTENSION(BlinkCard)) <MXMetricManagerSubscriber>
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("BlinkCard", usrValue)
...
namespace BlinkCard SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("BlinkCard") {


class BlinkCardSDK { } SWIFT_UNAVAILABLE_MSG("Swift struct 'BlinkCardSDK' cannot be represented in C++");

class BlinkCardScanningResult { } SWIFT_UNAVAILABLE_MSG("Swift struct 'BlinkCardScanningResult' cannot be represented in C++");

class BlinkCardSdk { } SWIFT_UNAVAILABLE_MSG("Swift class 'BlinkCardSdk' cannot be represented in C++");

class BlinkCardSdkSettings { } SWIFT_UNAVAILABLE_MSG("Swift struct 'BlinkCardSdkSettings' cannot be represented in C++");

class BlinkCardSession { } SWIFT_UNAVAILABLE_MSG("Swift class 'BlinkCardSession' cannot be represented in C++");

class BlinkCardSessionSettings { } SWIFT_UNAVAILABLE_MSG("Swift struct 'BlinkCardSessionSettings' cannot be represented in C++");
...
class CardAccountResult { } SWIFT_UNAVAILABLE_MSG("Swift struct 'CardAccountResult' cannot be represented in C++");

class CardLivenessCheckResult { } SWIFT_UNAVAILABLE_MSG("Swift struct 'CardLivenessCheckResult' cannot be represented in C++");

class CardNumberRedactionSettings { } SWIFT_UNAVAILABLE_MSG("Swift struct 'CardNumberRedactionSettings' cannot be represented in C++");

class CardRotation { } SWIFT_UNAVAILABLE_MSG("Swift enum 'CardRotation' cannot be represented in C++");

class CheckResult { } SWIFT_UNAVAILABLE_MSG("Swift enum 'CheckResult' cannot be represented in C++");

class CroppedImageResult { } SWIFT_UNAVAILABLE_MSG("Swift struct 'CroppedImageResult' cannot be represented in C++");

class CroppedImageSettings { } SWIFT_UNAVAILABLE_MSG("Swift struct 'CroppedImageSettings' cannot be represented in C++");

// Unavailable in C++: Swift type alias 'DPI'.

class DateResult { } SWIFT_UNAVAILABLE_MSG("Swift struct 'DateResult' cannot be represented in C++");
...
class ExtractionSettings { } SWIFT_UNAVAILABLE_MSG("Swift struct 'ExtractionSettings' cannot be represented in C++");
...
class LivenessSettings { } SWIFT_UNAVAILABLE_MSG("Swift struct 'LivenessSettings' cannot be represented in C++");
...
class StrictnessLevel { } SWIFT_UNAVAILABLE_MSG("Swift enum 'StrictnessLevel' cannot be represented in C++");
